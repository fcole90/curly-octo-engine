...
"""
DO NOT USE THIS FILE! IT'S DEPRECATED!
...
print("Color data:", len(__color_data__))
...
print("Input data: ", len(__input_data__))
...
print("Train data: ", len(__train_data__))
...
x_y_couples_train = __x_y_couples_train__()
print("XY couples train", len(x_y_couples_train))
...
def next_batch_x_y_couples(n=100) -> tuple:
    ...
    index_list = rd.sample(range(len(x_y_couples_train)), n)

    return ([x_y_couples_train[i][0] for i in index_list],
            [x_y_couples_train[i][1] for i in index_list])
